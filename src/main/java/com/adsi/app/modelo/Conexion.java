...
public class Conexion {
    ...
    public void conectar() throws SQLException, IOException {
        ...
        setDriver("com.mysql.jdbc.Driver");//Cambia las configuraciones globales
        //setUrl("jdbc:mysql://localhost:3306/registro?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
        setUrl("jdbc:mysql://localhost:3306/registro?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
        setUser("root");
        setPassword("1234");
